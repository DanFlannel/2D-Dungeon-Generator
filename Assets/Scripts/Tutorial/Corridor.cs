        ...
        public void SetupCorridor(Room room, IntRange length, IntRange roomWidth, IntRange roomHeight, int columns, int rows, bool firstCorridor)
        {
            ...
            switch (direction)
            {
                ...
                case Direction.North:
                    ...
                    startXPos = UnityEngine.Random.Range(room.xPos, room.xPos + room.roomWidth - 1);
                ...
                case Direction.East:
                    ...
                    startYPos = UnityEngine.Random.Range(room.yPos, room.yPos + room.roomHeight - 1);
                    maxLength = columns - startXPos - roomWidth.min;
                    break;
                case Direction.South:
                    startXPos = UnityEngine.Random.Range(room.xPos, room.xPos + room.roomWidth);
                    startYPos = room.yPos;
                    maxLength = startYPos - roomHeight.min;
                    break;
                case Direction.West:
                    startXPos = room.xPos;
                    startYPos = UnityEngine.Random.Range(room.yPos, room.yPos + room.roomHeight);
